$(document).ready(function () {
    console.log("asset_breeding.js loaded")
});
...
function addRow_asset_breeding(tableID, list_of_cols) {
    ...
    if (tableID == "tab_Asset_breeding") {
        ...
        element1.onclick = function () {
            ...
            crud_asset_breeding("PUT", "ins_" + rowCount, list_of_cols);
        }
        ...
        element1.onclick = function () {
            ...
            delete_Row_asset_breeding(tableID);
        }
        cell1.appendChild(element1);
...
function delete_Row_asset_breeding(tableID) {
    try {
        var table = document.getElementById(tableID);
        var rowCount = table.rows.length;
