$(document).ready(function () {
    console.log("asset_medical.js loaded")
});

function crud_asset_medical(action, id, column_list) {

    var url = "asset_medical";
    var data_in = {
        'id': id
    };
...
function addRow_asset_medical(tableID, list_of_cols) {
    ...
    if (tableID == "tab_Asset_medical") {
        ...
        element1.onclick = function () {
            ...
            crud_asset_medical("PUT", "ins_" + rowCount, list_of_cols);
        }
        ...
        element1.onclick = function () {
            ...
            delete_Row_asset_medical(tableID);
        }
        cell1.appendChild(element1);
...
function delete_Row_asset_medical(tableID) {
    try {
        var table = document.getElementById(tableID);
        var rowCount = table.rows.length;
