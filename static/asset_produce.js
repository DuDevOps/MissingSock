$(document).ready(function () {
    console.log("asset_produce.js loaded")
});
...
function addRow_asset_produce(tableID, list_of_cols) {
    ...
    if (tableID == "tab_Asset_produce") {
        ...
        element1.onclick = function () {
            ...
            crud_asset_produce("PUT", "ins_" + rowCount, list_of_cols);
        }
        ...
        element1.onclick = function () {
            ...
            delete_Row_asset_produce(tableID);
        }
        cell1.appendChild(element1);
...
function delete_Row_asset_produce(tableID) {
    try {
        var table = document.getElementById(tableID);
        var rowCount = table.rows.length;
