$(document).ready(function () {
    console.log("asset_offspring.js loaded")
});
...
function addRow_asset_offspring(tableID, list_of_cols) {
    ...
    if (tableID == "tab_Asset_offspring") {
        // ins button
        ...
        element1.onclick = function () {
            ...
            crud_asset_offspring("PUT", "ins_" + rowCount, list_of_cols);
        }
        ...
        element1.onclick = function () {
            ...
            delete_Row_asset_offspring(tableID);
        }
        cell1.appendChild(element1);
...
function delete_Row_asset_offspring(tableID) {
    try {
        var table = document.getElementById(tableID);
        var rowCount = table.rows.length;
